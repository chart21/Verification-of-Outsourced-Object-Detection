...
|--------------------------------|--------------|-----------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-----------------------------------------------------|
|Dishonest Behavior by Individual|1             |Contractor sends back false response to save resources                      |Sampling-based re-execution, utilization of a third-party Verifier if required     |>99% (with small sampling size) / 100% (with sampling rate of 1)|
