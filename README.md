...
|--------------------------------|--------------|-----------------------------------------------------------------------------|-----------------------------------------------------------------------------------|-----------------------------------------------------|
|Dishonest Behavior by Individual|1             |Contractor sends back false response to save resources                      |Sampling-based re-execution, utilization of a third-party Verifier if required     |Up to 100%|
