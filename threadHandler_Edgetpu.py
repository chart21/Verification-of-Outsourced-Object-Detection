#This class initilazises 3 threads to deal with taks in paralllel to CNN inference of the Edge TPU
import sys
import socket
import traceback
import cv2
...
class ThreadHandler:
    ...
    # Thread 3 (decompressing, verifying) section
...
# Thread 3 (postprocessing, decompressing, verifying, preporcessing) section
