...
class Parameters:
    ...
    port_outsourcer = 5556
    private_key_verifier = b'b\xc8\x8c\xa4\xd5\x82\x18cU\xfa\xdb\x0cg"\x06K\xa7\x01@\x9a\xf7\xa5Yn\x1b>|\x9a\xb6\x02\xaf&'
    framework = '' #tflite, tfRT, tf
    sendingPort = 1235

    minimum_receive_rate_from_contractor = 0 #contractor has to reecive and acknowledge atleast x% of resonses. Otherwise contract is aborted.
