...
def main():
    ...
    # initialize model
    model = Model()
    #model.load_model('models_edgetpu/quant_coco-tiny-v3-relu_edgetpu.tflite')
    #model.load_model('models_edgetpu/mobilenet_v2_1.0_224_quant_edgetpu.tflite')
    #model.load_model('models_edgetpu/ssd_mobilenet_v2_coco_quant_postprocess_edgetpu.tflite')
    #model.load_model('models_edgetpu/quant_coco-tiny-v3-relu_edgetpu.tflite')
    model.load_model('models_edgetpu/inception_v1_224_quant_edgetpu.tflite')
