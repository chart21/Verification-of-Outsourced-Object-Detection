...
import sys
import videoStramSubscriber2 as vss2
...
def main(_argv):
    ...
    receiver = vss2.VideoStreamSubscriber(hostname, port, merkle_tree_interval, contractHash, minimum_receive_rate_from_contractor, vk, input_size)
